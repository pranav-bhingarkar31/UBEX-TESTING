...
export default function PartnerPage({ setActiveTabInApp }: PartnerPageProps) {
  return (
    <div className="min-h-[60vh] bg-slate-900 text-slate-100 flex flex-col items-center justify-center p-6 border-t border-slate-800">
      <div className="max-w-md text-center space-y-6">
        ...
        <div className="space-y-2">
          <h1 className="text-3xl font-bold tracking-tight text-white mb-2 font-sans">Partner With Us</h1>
          <p className="text-sm text-slate-400 leading-relaxed font-light font-sans">
            Collaborate with UbEx! Land hosts, localized guides, experience providers, and event managers who want to integrate with our premium network. Registration forms are coming soon.
          </p>
        </div>
        <div>
          <button
