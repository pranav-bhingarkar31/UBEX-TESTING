                  ...
                  <div className="space-y-1.5 relative text-left">
                    ...
                    {showDatePickerPopup && (
                      <>
                        ...
                        />
                        <div className="fixed md:absolute top-1/2 md:top-[108%] left-1/2 md:left-auto md:right-0 -translate-x-1/2 -translate-y-1/2 md:translate-x-0 md:translate-y-0 z-50 w-[92vw] max-w-[340px] md:w-[310px] md:max-w-none select-none">
                          <UbexDatePicker
